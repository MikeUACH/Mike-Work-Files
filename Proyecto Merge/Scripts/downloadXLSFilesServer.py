...
def main():
    ...
    carpeta_script = r'C:\Users\EJRuiz\Desktop\Proyecto Merge\Scripts'
    ...
    ruta_CrearBatDinamicoCCR = os.path.join(carpeta_script, 'CrearBatDinamicoCCR.py')
    ...
    ejecutar_script(ruta_CrearBatDinamico)
...
#--------------------Para CCR------------------------------------
    ...
    #ejecutar_script(ruta_CrearBatDinamicoCCR)
